...
// Import songs
import song1 from "../static/songs/Kesariya_64(PagalWorld.cm).mp3"
import song2 from "../static/songs/Maan Meri Jaan_64(PagalWorld.cm).mp3"
import song3 from "../static/songs/Mere Dhol Judaiyan De_64(PagalWorld.cm).mp3"
import song4 from "../static/songs/Tu Hai To Mujhe Phir Aur Kya Chahiye_64(PagalWorld.cm).mp3"
import song5 from "../static/songs/What Jhumka_64(PagalWorld.cm).mp3"

// Import song cover images
import song1Img from "../static/Post Malone - White Iverson.jpg";
import song2Img from "../static/John Denver - Country Roads.jpeg";
import song3Img from "../static/Sigrid - High Five.jpg";
import song4Img from "../static/Khalid - Young Dumb Broke.jpeg";
import song5Img from "../static/Never Gonna Give You Up.avif";

// Import wallpapers
import Wallpaper1 from "../static/wallpaper1.jpg"
import Wallpaper2 from "../static/wallpaper2.webp"
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songItems: ["KESARIYA", "Maan Meri Jaan", "Mere Dhol Judaiyan De","Tu Hai To Mujhe Phir Aur Kya Chahiye","What Jhumka"], //song names
